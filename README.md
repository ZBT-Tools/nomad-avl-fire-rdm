...
NOMAD plugin for Research Data Management for CFD Simulations with AVL FIRE
...
```sh
git clone https://github.com/ZBT-Tools/nomad-avl-fire-rdm.git
cd nomad-avl-fire-rdm
